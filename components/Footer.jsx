      ...
      <div className="px-4 lg:px-8">
        <div className="md:flex md:items-start md:justify-between">
          ...
          <ul className="flex list-none mt-6 md:mt-0 space-x-3">
            ...
            <li>
              <a href="https://github.com/" target="_blank" aria-label="GitHub" className="h-10 w-10 flex items-center justify-center rounded-full bg-gray-800 hover:bg-gray-700">
